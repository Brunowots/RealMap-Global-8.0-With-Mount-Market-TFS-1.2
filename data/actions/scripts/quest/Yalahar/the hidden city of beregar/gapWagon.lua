function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	local stone1 = Game.createItem(7644, 1, Position(32571, 31508, 9))
	if stone1 then
		stone1:setActionId(50109)
	end
	local stone2 = Game.createItem(7642, 1, Position(32571, 31508, 9))		
	local stone2 = Game.createItem(4608, 1, Position(32571, 31508, 9))		
