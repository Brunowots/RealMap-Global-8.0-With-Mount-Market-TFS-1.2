...
enum itemAttrTypes : uint32_t {
	...
	ITEM_ATTRIBUTE_BREAKCHANCE = 1 << 23,
...
enum itemAbilityTypes : uint64_t {
	ITEM_ABILITY_NONE = 0,
	ITEM_ABILITY_HEALTHGAIN = 1ULL << 1,
	ITEM_ABILITY_HEALTHTICKS = 1ULL << 2,
	ITEM_ABILITY_MANAGAIN = 1ULL << 3,
	ITEM_ABILITY_MANATICKS = 1ULL << 4,
	ITEM_ABILITY_CONDITIONSUPPRESSIONS = 1ULL << 5,
	ITEM_ABILITY_MAXHITPOINTS = 1ULL << 6,
	ITEM_ABILITY_MAXMANAPOINTS = 1ULL << 7,
	ITEM_ABILITY_MAGICPOINTS = 1ULL << 8,
	ITEM_ABILITY_MAXHITPOINTSPERCENT = 1ULL << 9,
	ITEM_ABILITY_MAXMANAPOINTSPERCENT = 1ULL << 10,
	ITEM_ABILITY_MAXMAGICPOINTSPERCENT = 1ULL << 11,
	ITEM_ABILITY_CRITICALHITCHANCE = 1ULL << 12,
	ITEM_ABILITY_CRITICALHITAMOUNT = 1ULL << 13,
	ITEM_ABILITY_LIFELEECHCHANCE = 1ULL << 14,
	ITEM_ABILITY_LIFELEECHAMOUNT = 1ULL << 15,
	ITEM_ABILITY_MANALEECHCHANCE = 1ULL << 16,
	ITEM_ABILITY_MANALEECHAMOUNT = 1ULL << 17,
	ITEM_ABILITY_SKILLFIST = 1ULL << 18,
	ITEM_ABILITY_SKILLCLUB = 1ULL << 19,
	ITEM_ABILITY_SKILLSWORD = 1ULL << 20,
	ITEM_ABILITY_SKILLAXE = 1ULL << 21,
	ITEM_ABILITY_SKILLDISTANCE = 1ULL << 22,
	ITEM_ABILITY_SKILLSHIELD = 1ULL << 23,
	ITEM_ABILITY_SPEED = 1ULL << 24,
	ITEM_ABILITY_ABSORBPHYSICAL = 1ULL << 25,
	ITEM_ABILITY_ABSORBENERGY = 1ULL << 26,
	ITEM_ABILITY_ABSORBEARTH = 1ULL << 27,
	ITEM_ABILITY_ABSORBFIRE = 1ULL << 28,
	ITEM_ABILITY_ABSORBWATER = 1ULL << 29,
	ITEM_ABILITY_ABSORBICE = 1ULL << 30,
	ITEM_ABILITY_ABSORBHOLY = 1ULL << 31,
	ITEM_ABILITY_ABSORBDEATH = 1ULL << 32,
	ITEM_ABILITY_ELEMENTTYPE = 1ULL << 33,
	ITEM_ABILITY_ELEMENTDAMAGE = 1ULL << 34,
	ITEM_ABILITY_ELEMENTICE = 1ULL << 35,
	ITEM_ABILITY_ELEMENTHOLY = 1ULL << 36,
	ITEM_ABILITY_ELEMENTDEATH = 1ULL << 37,
	ITEM_ABILITY_ELEMENTEARTH = 1ULL << 38,
	ITEM_ABILITY_ELEMENTFIRE = 1ULL << 39,
	ITEM_ABILITY_ELEMENTWATER = 1ULL << 40,
	ITEM_ABILITY_ELEMENTENERGY = 1ULL << 41,
	ITEM_ABILITY_MANASHIELD = 1ULL << 42,
	ITEM_ABILITY_INVISIBLE = 1ULL << 43,
	ITEM_ABILITY_REGENERATION = 1ULL << 44,
	ITEM_ABILITY_DAMAGEMITIGATION = 1ULL << 45,
	ITEM_ABILITY_BONUSREGEN = 1ULL << 46,
	ITEM_ABILITY_MAGICDAMAGE = 1ULL << 47,
	ITEM_ABILITY_SUPPORTHEALING = 1ULL << 48,
	ITEM_ABILITY_ATTACKSPEED = 1ULL << 49,
	ITEM_ABILITY_FLEXSKILL = 1ULL << 50,
	ITEM_ABILITY_BONUSHEALING = 1ULL << 51,
	ITEM_ABILITY_ELEMENTNONE = 1ULL << 52,
};
