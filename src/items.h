...
enum ItemParseAttributes_t {
	...
	ITEM_PARSE_REFLECTPERCENTPERCENTALL,
	ITEM_PARSE_REFLECTPERCENTPERCENTELEMENTS,
	ITEM_PARSE_REFLECTPERCENTPERCENTMAGIC,
	...
	ITEM_PARSE_INCREASEPERCENTFIRE,
	ITEM_PARSE_INCREASEPERCENTDEATH,
	ITEM_PARSE_INCREASEPERCENTEARTH,
	ITEM_PARSE_INCREASEPERCENTPHYSICAL,
	ITEM_PARSE_INCREASEPERCENTALL,
	ITEM_PARSE_INCREASEPERCENTHOLY,
	ITEM_PARSE_INCREASEPERCENTICE,
	ITEM_PARSE_INCREASEPERCENTENERGY,
	ITEM_PARSE_INCREASEPERCENTLUCKY,
	ITEM_PARSE_INCREASEPERCENTCAPACITY,
	ITEM_PARSE_INCREASEPERCENTFASTATTACK,
	ITEM_PARSE_INCREASEPERCENTHEALING,
	ITEM_PARSE_INCREASEPERCENTMAGIC,
...
struct Abilities {
	...
	//increase abilities modifires
	int16_t increasePercent[COMBAT_COUNT] = { 0 };

	//increase lucky modifires
	int16_t increaseLucky[COMBAT_COUNT] = { 0 };

	//increase cap modifires
	int16_t increaseCapacity[COMBAT_COUNT] = { 0 };

	//increase fast attack modifires
	int16_t increaseFastattack[COMBAT_COUNT] = { 0 };
