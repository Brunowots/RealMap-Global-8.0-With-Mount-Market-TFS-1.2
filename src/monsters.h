...
class MonsterType
{
	...
	public:
		...
		bool createLootContainer(Container* parent, const LootBlock& lootblock, Player* owner);
		std::vector<Item*> createLootItem(const LootBlock& lootBlock, Player* owner);
};
...
class Monsters
{
	public:
		...
		static uint32_t getLootRandom(Player* owner);
