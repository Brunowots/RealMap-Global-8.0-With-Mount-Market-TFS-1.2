...
class Game
{
	public:
		...
		void playerRequestOutfitOTC(uint32_t playerId);
		...
		//bool combatChangeMana(Creature* attacker, Creature* target, int32_t manaChange, CombatOrigin origin);  //OLD
		bool combatChangeMana(Creature* attacker, Creature* target, CombatDamage& damage); //ADDED
