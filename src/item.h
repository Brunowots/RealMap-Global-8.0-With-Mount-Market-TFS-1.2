...
enum AbilityTypes_t {
	...
	ABILITY_MAXMAGICPOINTSPERCENT = 11,
	ABILITY_CRITICALHITCHANCE = 12,
	ABILITY_CRITICALHITAMOUNT = 13,
	ABILITY_LIFELEECHCHANCE = 14,
	ABILITY_LIFELEECHAMOUNT = 15,
	ABILITY_MANALEECHCHANCE = 16,
	ABILITY_MANALEECHAMOUNT = 17,
	ABILITY_SKILLFIST = 18,
	ABILITY_SKILLCLUB = 19,
	ABILITY_SKILLSWORD = 20,
	ABILITY_SKILLAXE = 21,
	ABILITY_SKILLDISTANCE = 22,
	ABILITY_SKILLSHIELD = 23,
	ABILITY_SPEED = 24,
	ABILITY_ABSORBPHYSICAL = 25,
	ABILITY_ABSORBENERGY = 26,
	ABILITY_ABSORBEARTH = 27,
	ABILITY_ABSORBFIRE = 28,
	ABILITY_ABSORBWATER = 29,
	ABILITY_ABSORBICE = 30,
	ABILITY_ABSORBHOLY = 31,
	ABILITY_ABSORBDEATH = 32,
	ABILITY_ELEMENTTYPE = 33,
	ABILITY_ELEMENTDAMAGE = 34,
	ABILITY_MANASHIELD = 35,
	ABILITY_INVISIBLE = 36,
	ABILITY_REGENERATION = 37,
	ABILITY_DAMAGEMITIGATION = 38,
	ABILITY_BONUSREGEN = 39,
	ABILITY_MAGICDAMAGE = 40,
	ABILITY_SUPPORTHEALING = 41,
	ABILITY_ATTACKSPEED = 42,
	ABILITY_FLEXSKILL = 43,
	ABILITY_BONUSHEALING = 44,
	ABILITY_ELEMENTICE = 45,
	ABILITY_ELEMENTHOLY = 46,
	ABILITY_ELEMENTDEATH = 47,
	ABILITY_ELEMENTEARTH = 48,
	ABILITY_ELEMENTFIRE = 49,
	ABILITY_ELEMENTWATER = 50,
	ABILITY_ELEMENTENERGY = 51,
	ABILITY_ELEMENTNONE = 52,

	ABILITY_START = ABILITY_NONE,
	ABILITY_END = ABILITY_ELEMENTNONE
};
...
public:
	...
	virtual void serializeAbility(PropWriteStream& abilStream) const;
	...
	int32_t getBreakChance() const {
		if (hasAttribute(ITEM_ATTRIBUTE_BREAKCHANCE)) {
			return getIntAttr(ITEM_ATTRIBUTE_BREAKCHANCE);
		}
		return items[id].breakChance;
	}
